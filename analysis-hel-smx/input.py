...
conf['smx']['smxcut']=0.3 #cut on data
conf['smx']['x0']=0.1 #x0 in small-x hel evo and \Delta q+ calculation 
conf['smx']['xsep']=0.1 #x value below which small-x hel starts
...
#conf['diatasets']['pidis']['xlsx'][70000] = 'pidis/expdata/70000.xlsx' # 70000 | proton | Apa  | EIC pseudo-data    |
#conf['pidis grid'] = {}
#conf['pidis grid']['overwrite']=False
#conf['pidis grid']['xlsx']=[]
#conf['pidis grid']['xlsx'].append('%s/database/pidis/expdata/70000.xlsx'%os.environ['FITPACK']
...
conf['params']['ppdf_smx']['up1 a']   ={'value':    -5, 'min':    -10, 'max':  0, 'fixed':False}
conf['params']['ppdf_smx']['up1 b']   ={'value':    -5., 'min':     -10, 'max':    10, 'fixed':False}
conf['params']['ppdf_smx']['up1 c']   ={'value':    5., 'min':   0, 'max':    10, 'fixed':False}
conf['params']['ppdf_smx']['up1 lam2smx']   ={'value':    1.0, 'min':   0.01, 'max':    1.0, 'fixed':True}

conf['params']['ppdf_smx']['dp1 a']   ={'value':    -10, 'min':    -15, 'max':     -5, 'fixed':False}
conf['params']['ppdf_smx']['dp1 b']   ={'value':    20, 'min':     10, 'max':    30, 'fixed':False}
conf['params']['ppdf_smx']['dp1 c']   ={'value':    -5, 'min':   -10, 'max':    2, 'fixed':False}
conf['params']['ppdf_smx']['dp1 lam2smx']   ={'value':    1.0, 'min':   0.01, 'max':    1.0, 'fixed': 'up1 lam2smx'}

conf['params']['ppdf_smx']['sp1 a']   ={'value':    -2, 'min':    -15, 'max':    15, 'fixed':False}
conf['params']['ppdf_smx']['sp1 b']   ={'value':    5., 'min':     -10, 'max':    10, 'fixed':False}
conf['params']['ppdf_smx']['sp1 c']   ={'value':    2., 'min':   -5, 'max':    5, 'fixed':False}
conf['params']['ppdf_smx']['sp1 lam2smx']   ={'value':    1.0, 'min':   0.01, 'max':    1.0, 'fixed': 'up1 lam2smx'}
...
conf['params']['ppdf_smx']['um1 lam2smx']   ={'value':    1.0, 'min':   0.01, 'max':    1., 'fixed': 'up1 lam2smx'}
...
conf['params']['ppdf_smx']['dm1 lam2smx']   ={'value':    1.0, 'min':   0.01, 'max':    1., 'fixed': 'dm1 lam2smx'}
...
conf['params']['ppdf_smx']['sm1 lam2smx']   ={'value':    1.0, 'min':   0.01, 'max':    1., 'fixed': 'up1 lam2smx'}
